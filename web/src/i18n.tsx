...
const en = {
  ...
  poolName: "Pool Name",
  poolNamePlaceholder: "e.g. US Proxy Pool",
  poolProxyUrl: "Proxy URL",
  poolProxyUrlPlaceholder: "socks5://host:port (optional)",
  poolAccounts: "Accounts",
  addToPool: "Add",
  removeFromPool: "Remove",
  noAccountsInPool: "No accounts in this pool",
  availableAccounts: "Available Accounts",
  confirmDeletePool: "Confirm?",
  poolCreated: "Pool created",
  accountAlreadyInPool: "Account already in another pool",
  globalProxy: "Global Proxy (Default)",
  globalProxyDesc: "Fallback when pool has no proxy configured",
  poolProxy: "Pool Proxy:",
  noProxy: "No proxy (use global)",
  editName: "Click to edit name",
  belongsToPool: "Pool:",
  noPool: "Unassigned",
  noPools: "No pools configured",
  noPoolsHint: "Create a pool to group accounts and configure proxy routing",
...
const zh: Translations = {
  ...
  createPool: "+ 创建号池",
  poolName: "号池名称",
  poolNamePlaceholder: "例如：美国代理池",
  poolProxyUrl: "代理地址",
  poolProxyUrlPlaceholder: "socks5://host:port（可选）",
  poolAccounts: "账号列表",
  addToPool: "添加",
  removeFromPool: "移除",
  noAccountsInPool: "该号池暂无账号",
  availableAccounts: "可用账号",
  confirmDeletePool: "确认？",
  poolCreated: "号池已创建",
  accountAlreadyInPool: "该账号已属于其他号池",
  globalProxy: "全局代理（默认）",
  globalProxyDesc: "号池未配置代理时使用全局代理",
  poolProxy: "号池代理：",
  noProxy: "无代理（使用全局）",
  editName: "点击编辑名称",
  belongsToPool: "号池：",
  noPool: "未分配",
  noPools: "暂无号池",
  noPoolsHint: "创建号池以分组管理账号并配置代理路由",
